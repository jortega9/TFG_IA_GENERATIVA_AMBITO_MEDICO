...
RESULTS_PATH = os.path.join(config["data_path"]["processed_path"], "cox_univariante.csv")

PROMPT = """
<contexto>
{context}

Tu funcion es analizar los resultados del analisis de la regresion de COX univariante para dar
...
Mostrar la tabla con los resultados del analisis de regresion de COX.

Conclusiones:
Saca conclusiones y analiza profundamente los resultados de la regresion de COX para las variables
dadas.
...
<entrada>
Resultados estadísticos de la regresion de COX en CSV: {results}
...
class COXRegressionAgent(Agent):
    """"""
    def __init__(self):
        super().__init__()
...
def generate_cox_regression() -> str:
    """"""
    agent = COXRegressionAgent()
