...
const DescStatistics3 = () => {
    ...
    const handleDesc3 = async () => {
        ...
        try {
        const response = await fetch('http://127.0.0.1:8000/ai/testDescStatistics3', { method: 'POST' });
        ...
        setPorcentajes(resultVars.porcentajes);
        setFrecuencias(resultVars.frecuencias);
        } catch (error) {
